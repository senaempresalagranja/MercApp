<!-- Navigation -->
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0;background-color: orange">
			...
			<ul class=" nav navbar-nav">
				<li>
                   <a href="index.php"><i class="fa fa-product-hunt fa-fw"></i>  Productos</a>
                </li>
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li class="divider"></li>
						<li><a href="inventory.php"><span class="fa fa-barcode"></span>  Inventario</a></li>
                    </ul> 
				</li>
			</ul>
			
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown" style="background-color: red;color: white;">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<span class="glyphicon glyphicon-lock" style="color: white;"></span> <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu">
