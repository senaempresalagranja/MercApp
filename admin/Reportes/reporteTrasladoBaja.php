...
<script type="text/javascript">
	$(document).ready(function(){
		$('#tablaDatatable').load('Reportes/tablaReporteTrasladoBaja.php');
		inicio();
	});
...
function enviar() {
        ...
        $("#tablaDatatable").load("Reportes/reportes/reporteTrasladoBaja/filtrar/filtrarTrasladoBaja.php", {
            fecha1: fecha1,
            fecha2: fecha2,
        });
    ...
    $('#exportarExcel').click(function() {
		...
		location.href="Reportes/reportes/reporteTrasladoBaja/exportar/excel/exportarTrasladoBaja.php?fecha1="+fecha1 +"&fecha2="+fecha2+"";
            });
