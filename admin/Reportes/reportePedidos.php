...
<script type="text/javascript">
	$(document).ready(function(){
		$('#tablaDatatable').load('Reportes/tablaReportePedidos.php');
		inicio();
	});
...
function enviar() {
        ...
        $("#tablaDatatable").load("Reportes/reportes/reporte/filtrar/filtrarPedido.php", {
            fecha1: fecha1,
            fecha2: fecha2,
        });
	...
	$('#exportarExcel').click(function() {
        ...
        var fecha2 = document.getElementById('fecha2').value;
				...
				location.href="Reportes/reportes/reportePedidos/exportar/excel/exportarPedido.php?fecha1="+fecha1 +"&fecha2="+fecha2+"";
            });
