...
$reporteCsv=$conexion->query("SELECT tblote.codigoLote, tblote.responsableProduccion, tbentrada.fecha, tblote.fechaProduccion, tbproducto.nombre, 
...
while ($fila=mysqli_fetch_row($reporteCsv)) {
?>
...
header('Content-Disposition: attachment;filename="Reporte Entrada (MercApp).xls"');
