...
$sql="SELECT idArea, nombre FROM tbarea";
			...
			<?php while ($mostrar=mysqli_fetch_row($result)) {
				...
				<tr >
					...
					<td style="text-align: center;">
						<span class="btn btn-warning btn-sm" data-toggle="modal" data-target="#ActualizarArea" onclick="agregaFrmActualizarArea('<?php echo $mostrar[0] ?>')">
