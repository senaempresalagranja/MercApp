...
$sql="SELECT idUnidadMedida, unidadMedida FROM tbUnidadmedida";
			...
			<?php while ($mostrar=mysqli_fetch_row($result)) {
				...
				<tr >
					...
					<td style="text-align: center;">
						<span class="btn btn-warning btn-sm" data-toggle="modal" data-target="#ActualizarUnidadMedida" onclick="agregaFrmActualizarUnidadMedida('<?php echo $mostrar[0] ?>')">
